...
% Headers
\lhead{} % Left header
\chead{\thetitle} % Center header - currently printing the article title
\rhead{} % Right header
...
\newcommand{\lettrineabstract}[1]{
	...
	\noindent\textbf{\StrGobbleLeft{#1}{0}}   
}
